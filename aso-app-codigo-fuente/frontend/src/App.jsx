...
function App() {
  ...
  const allCategories = ['Todas', ...new Set(skills.map(s => s.category || 'Sin categoría').sort())];
              ...
              {allCategories.map(cat => (
                ...
                >
                  ...
                  <span className="ml-1.5 opacity-60">
                    {cat === 'Todas'
                      ? skills.filter(s => activeTab === 'activas' ? s.isActive : !s.isActive).length
                      : skills.filter(s => (activeTab === 'activas' ? s.isActive : !s.isActive) && (s.category || 'Sin categoría') === cat).length
                    }
                  </span>
                </button>
              ))}
