...
description: La descripción técnica se refiere a cómo escribir código en n8n con nodos de código y utiliza Python. 

El texto es corto, por lo que traduciré directamente:

Utilice la sintaxis _input/_json/_node al escribir Python en n8n, ya sea cuando esté trabajando con la biblioteca estándar o necesite comprender las limitaciones de Python en los nodos de código.
