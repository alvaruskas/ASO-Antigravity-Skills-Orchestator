...
description: Interpreta errores de validación y guía la corrección de ellos. Utiliza cuando se encuentren con errores de validación, advertencias de validación, falsos positivos, problemas en la estructura de operadores o necesiten ayuda para entender los resultados de validación. También utiliza cuando pregunte sobre perfiles de validación, tipos de error o el proceso del bucle de validación.
